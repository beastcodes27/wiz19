...
<head>
  ...
  <title><?= htmlspecialchars($platform_name) ?> - Transactions</title>
...
<body>
  ...
  <script>
      $(document).ready(function() {
          ...
          // Note: Change the 'ajax' URL to point to your backend script that generates the JSON
          $('#yajraTable').DataTable({
              processing: true,
              serverSide: true,
              ajax: "api/transactions.php", // Make sure this backend script exists and returns proper JSON format
              columns: [{
                      data: 'DT_RowIndex',
                      name: 'DT_RowIndex',
                      orderable: false,
